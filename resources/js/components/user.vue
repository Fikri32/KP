            ...
            <div class="panel">
               ...
               <div class="form-group form-material">
                ...
                <table class="table is-indent">
                    <thead>
                        <tr>
                            <th scope="col" @click="setSort('nama')">nama <i class="icon wb-sort-vertical" aria-hidden="true"></i></th>
                            <th scope="col" @click="setSort('nip')">NIP <i class="icon wb-sort-vertical" aria-hidden="true"></i></th>
                            <th scope="col" @click="setSort('email')">E-Mail <i class="icon wb-sort-vertical" aria-hidden="true"></i></th>
                            <th scope="col" @click="setSort('posisi')">Posisi</th>
